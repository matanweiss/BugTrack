...
const NavBar = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  return (
    <nav className={`${scrolledDown ? 'bg-red-700 shadow-lg text-white' : `${location.pathname.includes('/dashboard') ? 'lg:bg-gray-50' : 'bg-transparent'} text-red-700`} z-10 sticky top-0 h-16  pl-2 pr-3 transition`}>
