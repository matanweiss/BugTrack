const DashboardMenu = ({ props }) => {
  ...
  const handleMouseUp = e => console.log('nada');
  

  return (
    <div className="animate-fadeIn mt-4 mx-8 md:mx-0 flex flex-col pb-2 items-start pr-5 pt-4 h-full relative space-y-2">

      <button 
        onClick={() => { handleClick('all') }} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp}
      ...
      <button onClick={() => { handleClick('features') }} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp}
      ...
      <button onClick={() => { handleClick('bugs') }} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp}
      ...
      <button onClick={() => { handleClick('settings') }} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp}
