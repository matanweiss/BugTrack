...
const DashboardMenu = ({ props }) => {
  ...
  return (
    <motion.div
      ...
      className="mx-8 md:mx-0 flex flex-col pb-2 items-start pr-5 pt-4 h-full relative space-y-2" layout="position">
        
      <motion.div className="hidden sm:hidden border-r-2 border-red-200 h-2/3 right-0 inset-y-0 my-auto absolute" layout></motion.div>

      <motion.button {...tapVariants}
