const DashboardMenu = ({ props }) => {
  ...
  return (
    <div className="animate-fadeIn mt-4 mx-8 md:mx-0 flex flex-col pb-2 items-start pr-5 pt-4 h-full relative space-y-2">
      ...
      <button 
        onClick={() => { handleClick('all') }} onMouseDown={handleMouseDown}
      ...
      <button onClick={() => { handleClick('features') }} onMouseDown={handleMouseDown}
      ...
      <button onClick={() => { handleClick('bugs') }} onMouseDown={handleMouseDown}
      ...
      <button onClick={() => { handleClick('settings') }} onMouseDown={handleMouseDown}
